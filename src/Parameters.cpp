...
// make sure there's a "/" at the end of the folder names
	...
	nstep=int(tsim/dt+0.5);
	nprint=int(tprint/dt+0.5);
	nprintini=int(tprintini/dt+0.5);
...
void Parameters::print(string filename) {
	...
	os << setw(w) << "tprintini" << setw(w) << tprintini << endl;
...
// box
	...
	os << setw(w) << "boxVec1x" << setw(w) << setprecision(p) << boxVec1.x << endl;
	os << setw(w) << "boxVec1y" << setw(w) << setprecision(p) << boxVec1.y << endl;
	os << setw(w) << "boxVec2x" << setw(w) << setprecision(p) << boxVec2.x << endl;
	os << setw(w) << "boxVec2y" << setw(w) << setprecision(p) << boxVec2.y << endl;
	os << setw(w) << "boxRadius" << setw(w) << setprecision(p) << boxRadius << endl;
...
// initializer
	...
	os << setw(w) << "iniboxVec1x" << setw(w) << iniboxVec1.x << endl;
	os << setw(w) << "iniboxVec1y" << setw(w) << iniboxVec1.y << endl;
	os << setw(w) << "iniboxVec2x" << setw(w) << iniboxVec2.x << endl;
	os << setw(w) << "iniboxVec2y" << setw(w) << iniboxVec2.y << endl;
